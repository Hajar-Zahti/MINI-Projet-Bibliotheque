...
public class AjoutExemplaire extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        titleLabel.setFont(new Font("Arial", Font.BOLD | Font.ITALIC, 28)); // NOI18N
        titleLabel.setForeground(new Color(0, 64, 128));
        titleLabel.setText("Ajouter un  Exemplaire");
        	...
        	panAjoutBasLayout.createParallelGroup(Alignment.LEADING)
        		.addGroup(panAjoutBasLayout.createSequentialGroup()
        			...
        			.addGroup(panAjoutBasLayout.createParallelGroup(Alignment.CENTER)
        				.addComponent(etatExemplaireCombo, 0, 238, Short.MAX_VALUE)
        				.addComponent(identifiantField, GroupLayout.DEFAULT_SIZE, 238, Short.MAX_VALUE))
        			.addContainerGap())
        		.addGroup(panAjoutBasLayout.createSequentialGroup()
        			.addGap(47)
        ...
        jPanel1Layout.setVerticalGroup(
        	jPanel1Layout.createParallelGroup(Alignment.LEADING)
        		.addGroup(jPanel1Layout.createSequentialGroup()
        			...
        			.addGap(18)
        			.addComponent(panAjoutBas, GroupLayout.DEFAULT_SIZE, 188, Short.MAX_VALUE)
        			.addContainerGap())
        );
