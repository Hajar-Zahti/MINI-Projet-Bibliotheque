...
import controllers.ExemplaireControl;
...
public class GestionReservationsEmprunts extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        EmpruntPanel.setBackground(new Color(192, 192, 192));

        panEmpCours.setBackground(new Color(192, 192, 192));
        ...
        menuEmpPanel.setBackground(new Color(192, 192, 192));
        ...
        panExemplaires.setBackground(new Color(192, 192, 192));
        ...
        titleResaEmpLabel.setFont(new Font("Arial", Font.BOLD, 31)); // NOI18N
        titleResaEmpLabel.setForeground(new Color(0, 64, 128));
        ...
        jPanel3Layout.setHorizontalGroup(
        	jPanel3Layout.createParallelGroup(Alignment.LEADING)
        		.addGroup(jPanel3Layout.createSequentialGroup()
        			...
        			.addGroup(jPanel3Layout.createParallelGroup(Alignment.LEADING)
        				.addComponent(auteurLabel1, GroupLayout.PREFERRED_SIZE, 56, GroupLayout.PREFERRED_SIZE)
        				.addComponent(typeOeuvreLabel1, GroupLayout.PREFERRED_SIZE, 113, GroupLayout.PREFERRED_SIZE)
        				.addComponent(nbExemplaire1, GroupLayout.PREFERRED_SIZE, 139, GroupLayout.PREFERRED_SIZE))
        			.addGap(18)
        			.addGroup(jPanel3Layout.createParallelGroup(Alignment.LEADING)
