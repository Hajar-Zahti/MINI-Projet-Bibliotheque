...
public class GestionOeuvresExemplaires extends javax.swing.JFrame implements MouseListener {
    ...
    private void initComponents() {
        ...
        panListeOeuvre.setBackground(new Color(192, 192, 192));
        			...
        			.addGroup(jPanel2Layout.createParallelGroup(Alignment.LEADING)
        				.addGroup(jPanel2Layout.createSequentialGroup()
        					.addGroup(jPanel2Layout.createParallelGroup(Alignment.LEADING)
        						...
        						.addComponent(ajouterBouton, GroupLayout.DEFAULT_SIZE, 107, Short.MAX_VALUE))
        					.addContainerGap())
        				.addGroup(jPanel2Layout.createSequentialGroup()
        ...
        jLabel1.setForeground(new Color(0, 64, 128));
